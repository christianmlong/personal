...
if (common.state_machine) {
    throw new Error("common.state_machine already exists");
}
else {
    ...
    function () {
        ...
        var StateMachine = {
            ...
            create: function(cfg, target) {
              ...
              fsm.error   = cfg.error || function(name, from, to, args, error, msg, e) { /*jshint unused:vars */ throw e || msg; }; // default behavior when something unexpected happens is to throw an exception, but caller can override this behavior if desired (see github issue #3 and #17)
